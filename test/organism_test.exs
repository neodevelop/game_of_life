defmodule OrganismTest do
  ...
  test "given an organism with an initial state of [[0, 0, 0], [0, 1, 0], [1, 0, 1]] it shuold return a new Organism structure" do
  ...
  test "given a cell in position [0, 0], it should return three neighbors" do
    cells = [[0, 0, 0], [0, 1, 0], [1, 0, 1]]
    organism = %Organism{cells: cells}
